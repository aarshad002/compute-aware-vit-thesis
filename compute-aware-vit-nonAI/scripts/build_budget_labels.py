...
def main():
        ...
        for budget_idx, budget_name, model in teachers:
            ...
            for batch in train_loader:
                if len(batch) == 3:
                    ...
                    raise ValueError(
                        "Expected train loader to return "
    ...
    for idx in range(total_train_samples):
        if idx not in budget_labels:
            budget_labels[idx] = 3

    output_path = ROOT / "data" / "budget_labels_train.json"
